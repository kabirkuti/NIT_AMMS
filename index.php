...
<body class="login-page">
    <div class="login-container">
        <div class="login-header">
            <h1>🎓 NIT AMMS </h1>
            <h2>Nagpur Institute Of Technology - Asset and Maintenance Management System</h2>
        </div>
   ...
   <div class="dev-info">
    ...
    <p class="dev-links">
        <a href="https://himanshufullstackdeveloper.github.io/techyugsoftware/" target="_blank">
